...
void ArrayPack::check() const {
  ...
  assert( topo_start.width()==fslope.width()        && topo_start.height==fslope.height()       );
  assert( topo_start.width()==temp.width()          && topo_start.height==temp.height()         );
  assert( topo_start.width()==equilibriated.width() && topo_start.height==equilibriated.height());
