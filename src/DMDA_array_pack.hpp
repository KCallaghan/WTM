...
struct DMDA_Array_Pack {
  ...
  PetscScalar** storativity_vec     = nullptr;
  ...
  DMDA_Array_Pack(const AppCtx& user) {
    ...
    DMDAVecGetArray(user.da, user.storativity_vec, &storativity_vec);
  ...
  void release() {
    ...
    DMDAVecRestoreArray(context->da, context->storativity_vec, &storativity_vec);
