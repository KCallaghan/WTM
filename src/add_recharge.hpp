...
double add_recharge(const double deltat, const double my_rech, double my_wtd, const double my_porosity){
  ...
  if(my_wtd >= 0){         //all the recharge will occur above the land surface; don't worry about porosity.
    ...
    const double GW_space = -my_wtd * my_porosity;  //if wtd is negative, this is the amount of above-ground equivalent recharge that can be accommodated below ground.
