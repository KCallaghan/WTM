...
equilibrium_w_sw.exe: Equilibrium_version_with_SW.f90          
	mpif90 -O3 -g Equilibrium_version_with_SW.f90           -o equilibrium_w_sw.exe  -I/usr/include -L/usr/lib/x86_64-linux-gnu/ -lnetcdff #-fsanitize=address

priority.exe:         priority-SW-coupled-GW-and-SW_WORKING.f90
	mpif90 -O3 -g priority-SW-coupled-GW-and-SW_WORKING.f90 -o priority.exe          -I/usr/include -L/usr/lib/x86_64-linux-gnu/ -lnetcdff #-fsanitize=address
